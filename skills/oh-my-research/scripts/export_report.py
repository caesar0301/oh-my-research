...
INTERNAL_PATTERNS = {
    ...
    "workflow name": re.compile(r"\bOMR\b|Evidence-Deep|THINK mode|SYNTH mode", re.I),
    "gate or QA name": re.compile(r"\bGate\s+[ABDL]\b|\bQA[12]\b", re.I),
    "private artifact path": re.compile(
        r"(?:docs/plans/|\.omr/|tree-state\.json)", re.I
    ),
...
LANG_STRINGS = {
    ...
    "zh-CN": {
        "toc": "目录",
        "subtitle": "深度研究报告",
        "generated": "由 oh-my-research 生成",
    },
    "zh-TW": {
        "toc": "目錄",
        "subtitle": "深度研究報告",
        "generated": "由 oh-my-research 產生",
    },
    "zh-HK": {
        "toc": "目錄",
        "subtitle": "深度研究報告",
    ...
    "ja": {
        "toc": "目次",
        "subtitle": "深度調査レポート",
        "generated": "oh-my-research により生成",
    },
    "ko": {
        "toc": "목차",
        "subtitle": "심층 연구 보고서",
        "generated": "oh-my-research로 생성",
    },
    "de": {
    ...
    "fr": {
        ...
        "generated": "Généré par oh-my-research",
    },
    "es": {
        "toc": "Índice",
        "subtitle": "Informe de investigación en profundidad",
        "generated": "Generado por oh-my-research",
    },
    "pt-BR": {
        "toc": "Sumário",
        "subtitle": "Relatório de pesquisa aprofundada",
        "generated": "Gerado por oh-my-research",
    },
    "pt-PT": {
        "toc": "Índice",
    ...
    "ru": {
        ...
        "generated": "Сгенерировано oh-my-research",
    },
    "ar": {
        "toc": "جدول المحتويات",
    ...
    "it": {
        ...
        "generated": "Generato da oh-my-research",
    },
    "nl": {
        "toc": "Inhoudsopgave",
    ...
    "vi": {
        ...
        "generated": "Được tạo bởi oh-my-research",
    },
